...
def combine_audio(num):
    ...
    try:
        ...
        if audio_duration > new_video_duration:
            ...
            adjusted_video_path = f'temp_adjusted_{num}.mp4'
            ...
            last_frame_path = f'temp_last_frame_{num}.png'
            ...
            freeze_path = f'temp_freeze_{num}.mp4'
            ...
            final_video_path = f'temp_final_video_{num}.mp4'
            concat_list = f'temp_concat_{num}.txt'
        ...
        # Case 2: Audio shorter than adjusted video (add silence)
            ...
            silence_path = f'temp_silence_{num}.mp3'
            ffmpeg.input(
                'anullsrc',
                f='lavfi',
            ...
            extended_audio_path = f'temp_extended_{num}.mp3'
            audio_concat_list = f'temp_audio_concat_{num}.txt'
